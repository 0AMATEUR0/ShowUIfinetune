...
def train(
    ...
    for local_step in range(args.steps_per_epoch):
        ...
        for i in range(args.grad_accumulation_steps):
            ...
            forward_dict.update(image_grid_thw=input_dict["image_grid_thw"]) if "image_grid_thw" in input_dict else None
        ...
        if "token_stat" in output_dict:
            n_text_tokens = output_dict["token_stat"]["n_text_tokens"]
            n_image_tokens = output_dict["token_stat"]["n_image_tokens"]
            n_video_tokens = output_dict["token_stat"]["n_video_tokens"]

        ctx_len.update(n_text_tokens)
        vis_len.update(n_image_tokens + n_video_tokens)
